...
public class LargeStreetRedSmallStreetOrange implements TrafficControllerState {

	TrafficControllerStateContext context;
	public LargeStreetRedSmallStreetOrange(TrafficControllerStateContext context) {
		System.out.println("In LargeStreetRedSmallStreetOrange ");
	...
	public void setVehicleAtSmallStreet(boolean isVehicleAtSmallStreet) {
		System.out.print("No change in state");
	}
