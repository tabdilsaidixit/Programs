...
public void carWashSysConstruct(){
    ...
    ViewableAtomic car_genr = new carGenr("carGenr",6);
...
//     addCoupling(trand,"out",car_genr,"in");
    ...
    public void layoutForSimView()
    {
        ...
        if((ViewableComponent)withName("carWashCenter")!=null)
             ((ViewableComponent)withName("carWashCenter")).setPreferredLocation(new Point(376, 117));
        if((ViewableComponent)withName("carGenr")!=null)
             ((ViewableComponent)withName("carGenr")).setPreferredLocation(new Point(90, 119));
    }
}
