...
/**
 * A tunable coordinator specialized to interoperate with a SimView.
 */
...
//      s msg  = new s();
//      msg.s("printing inside the SimviewCoordinator-----------------");
//      super.myCoupled.printCouprel(super.myCoupled.getCouprel());
