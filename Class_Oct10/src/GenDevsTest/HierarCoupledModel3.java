...
public class HierarCoupledModel3 extends ViewableDigraph
{
    ...
    public void layoutForSimView()
    {
        ...
        if((ViewableComponent)withName("HierarCoupledModel1")!=null)
             ((ViewableComponent)withName("HierarCoupledModel1")).setPreferredLocation(new Point(41, 70));
        if((ViewableComponent)withName("third")!=null)
             ((ViewableComponent)withName("third")).setPreferredLocation(new Point(592, 283));
    }
}
