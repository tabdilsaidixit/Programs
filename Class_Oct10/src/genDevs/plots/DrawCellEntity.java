...
public class DrawCellEntity extends entity
{
    ...
    public int resIndex; //Xiaolin Hu, Nov 16th, 2005
    ...
    /**
     * A convenience constructor.
     * Xiaolin Hu -- Nov 16th, 2005
     */
    public DrawCellEntity(String name, double i, double j, int resIndex, Color color)
    {
        this(name, i, j, color,0);//Color.black, 0);//bpz
        this.resIndex = resIndex;
    }

    public DrawCellEntity(String name, double i, double j, int resIndex, Color color, Color dimTo_)
    {
        this(name, i, j, color,0);//Color.black, 0);//bpz
        this.resIndex = resIndex;
        this.dimTo = dimTo_;
