...
//    protected Dimension spaceSize = new Dimension(30, 30);
//    protected Dimension spaceSize = new Dimension(60, 60);
    ...
    protected int resN = 5; // Xiaolin Hu
    ...
    public void drawMRCellToScale(double cellX, double cellY, int resIndex, Color color)
    {
        ...
        fillMRCellOnSwingThread(x, y, resIndex, color);
    }
    ...
    protected void fillCell(int pixelX, int pixelY, Color color)
    {
        ...
        grid[pixelX / cellSize][pixelY / cellSize][0] = color;
    }
        ...
        final Color color)
    {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                fillMRCell(pixelX, pixelY, resIndex, color);
            }
        });
    }
