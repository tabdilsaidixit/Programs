...
public efp (){
    super("efp");
    //ViewableAtomic sp = new proc("proc",30);
   ...
   initialize();
    ...
    public void layoutForSimView()
    {
        ...
        if((ViewableComponent)withName("m")!=null)
             ((ViewableComponent)withName("m")).setPreferredLocation(new Point(57, 197));
        if((ViewableComponent)withName("ExpFrame")!=null)
